...
{
    defineTypeNameAndDebug(sinCos, 0);
...
Foam::scalar Foam::waveModels::sinCos::eta
(
    const scalar H,
    const scalar Kx,
    const scalar x,
...
) const
{
    ...
    return H*0.5*(sin(phaseTot)+cos(phaseTot));
}


// * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * * //

Foam::scalar Foam::waveModels::sinCos::waveLength
(
    const scalar h,
    const scalar T
) const
...
Foam::vector Foam::waveModels::sinCos::UfBase
(
    const scalar H,
    const scalar h,
    const scalar Kx,
...
void Foam::waveModels::sinCos::setLevel
(
    const scalar t,
    const scalar tCoeff,
    scalarField& level
...
void Foam::waveModels::sinCos::setVelocity
(
    const scalar t,
    const scalar tCoeff,
...
bool Foam::waveModels::sinCos::readDict(const dictionary& overrideDict)
{
...
void Foam::waveModels::sinCos::info(Ostream& os) const
{
